  ...
  return (
    <div className="bg-white text-gray-500 max-w-96 mx-4 md:p-6 p-4 text-left text-sm rounded-xl shadow-[0px_0px_10px_0px] shadow-black/10">
      ...
      <h2 className="text-2xl font-semibold mb-6 text-center text-gray-800">
        {signState === "login" ? "Welcome back" : "Welcome"}
      </h2>
      ...
      <form>
        ...
        <input
          ...
          type="password"
          placeholder={signState === "login" ? "Enter your password" : "Create a password"}
          required
        />
        ...
        {signState === "login" ? (
          ...
          <div className="mt-2">
            <input
              id="confirmPassword"
              className="w-full bg-transparent border border-gray-500/30 outline-none rounded-full py-2.5 px-4 mt-2 mb-3"
              type="password"
      ...
      >
        ...
        {signState === "login" ? "Log in with Apple" : "Sign up with Apple"}
      </button>
      ...
      >
        ...
        {signState === "login" ? "Log in with Google" : "Sign up with Google"}
      </button>
    </div>
  );
}
