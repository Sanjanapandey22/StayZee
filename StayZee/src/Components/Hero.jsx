    ...
    <div className="relative h-screen w-full overflow-hidden z-0">
      ...
      <div className="relative z-10 mt-7">
        ...
        <div className="flex flex-col items-start justify-center h-[80vh] px-20 text-white max-w-[690px] ml-13 mt-25">
         ...
         <form className='bg-white text-gray-800 rounded-lg px-6 py-4 mt-8 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-[200px]'>
            ...
            <button className='flex items-center justify-center gap-1 rounded-md bg-rose-600 py-3 px-4 text-white my-auto cursor-pointer max-md:w-full max-md:py-1' >
